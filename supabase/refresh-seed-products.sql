...
FROM (
  VALUES
    ...
    ('00000000-0000-4000-8000-00000000005b'::uuid, '00000000-0000-4000-8000-000000000036'::uuid, '00000000-0000-4000-8000-00000000004a'::uuid, '00000000-0000-4000-8000-000000000016'::uuid,  0, TIME '23:59:00',  5, 2, 'active'),
...
-- Keep one late pickup sample available for local reservation/payment testing.
UPDATE public.products
SET
  pickup_start_time = TIME '18:00:00',
  pickup_end_time   = TIME '23:59:00'
WHERE id = '00000000-0000-4000-8000-00000000005b';
