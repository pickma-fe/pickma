...
| T09 | 501 API 및 UI 노출 목록 정리                                 | P0       | 진행 중 | 201          | 없음                    | [T09_api_501_ui_exposure_inventory.md](T09_api_501_ui_exposure_inventory.md)                                     |
...
| T51 | 판매자 대시보드 메인 화면 구현                               | P1       | 진행 전 | 확인 필요    | T10, T15                | [T51_seller_dashboard_page.md](T51_seller_dashboard_page.md)                                                     |
