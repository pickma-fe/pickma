...
| 🔍 검색       | -              | `/search`                | 상품/가게 검색 결과       | 전체   | 🚧 미구현 (T56) |
| 📦 상품 상세  | -              | `/products/[id]`         | 상품 정보, 가게 정보      | 전체   | ✅ 구현됨       |
...
| 👤 마이페이지 | -              | `/mypage`                | 마이페이지 메인           | 로그인 | ✅ 구현됨       |
|               | 📋 주문 내역   | `/mypage/orders`         | 주문 목록                 | 로그인 | 🚧 미구현 (T54) |
|               | 📄 주문 상세   | `/mypage/orders/[id]`    | 주문 상세, 픽업 정보      | 로그인 | 🚧 미구현 (T54) |
|               | ⚙️ 프로필 수정 | `/mypage/profile`        | 닉네임, 연락처 수정       | 로그인 | 🚧 미구현 (T55) |
|               | ❤️ 찜 목록     | `/mypage/wishlist`       | 관심 가게/상품            | 로그인 | 🚧 미구현       |
...
| Depth 1        | Depth 2   | URL                          | 설명                         | 권한        | 구현 상태       |
| -------------- | --------- | ---------------------------- | ---------------------------- | ----------- | --------------- |
| 🏠 판매자 홈   | -         | `/seller`                    | 서비스 소개, 등록 유도 (CTA) | 전체        | ✅ 구현됨       |
| 📝 판매자 신청 | -         | `/seller/register`           | 사업자 정보 + 서류 제출      | 로그인      | ✅ 구현됨       |
| ⏳ 심사 대기   | -         | `/seller/pending`            | 판매자 심사 상태 확인        | 신청자      | 🚧 미구현 (T50) |
| 📊 대시보드    | -         | `/seller/dashboard`          | 오늘의 주문 현황             | 판매자+가게 | 🚧 미구현 (T51) |
...
|                | 주문 상세 | `/seller/orders/[id]`        | 주문 상세, 픽업 처리         | 판매자+가게 | 🚧 미구현 (T52) |
...
| Depth 1        | Depth 2   | URL                      | 설명                  | 권한   | 구현 상태       |
| -------------- | --------- | ------------------------ | --------------------- | ------ | --------------- |
| 📊 대시보드    | -         | `/admin`                 | 플랫폼 통계           | 관리자 | ✅ 구현됨       |
| 🧾 판매자 승인 | -         | `/admin/sellers/pending` | 판매자 신청 승인/거절 | 관리자 | ✅ 구현됨       |
| 🏪 가게 관리   | -         | `/admin/stores`          | 전체 가게 목록        | 관리자 | ✅ 구현됨       |
...
/mypage ...................... 마이페이지 메인
/mypage/orders ............... 주문 내역 [🚧 T54]
/mypage/orders/[id] .......... 주문 상세 [🚧 T54]
/mypage/profile .............. 프로필 수정 [🚧 T55]
/mypage/wishlist ............. 찜 목록 [🚧 미구현]
(로그인) .................... 전역 모달 — 별도 URL 없음

판매자 영역
/seller ...................... 판매자 홈/온보딩 CTA
/seller/register ............. 판매자 신청
/seller/pending .............. 심사 대기 [🚧 T50]
