...
| ⏳ 심사 대기   | -         | `/seller/pending`            | 판매자 심사 상태 확인 및 신청 취소 | 신청자      | ✅ 구현됨 (T36)      |
| 📊 대시보드    | -         | `/seller/dashboard`          | 오늘의 주문 현황 및 매출 통계      | 판매자+가게 | ✅ 구현됨 (T51, T77) |
...
| Depth 1        | Depth 2 | URL                      | 설명                  | 권한   | 구현 상태     |
| -------------- | ------- | ------------------------ | --------------------- | ------ | ------------- |
| 📊 대시보드    | -       | `/admin`                 | 플랫폼 통계 대시보드  | 관리자 | ✅ 완료 (T58) |
| 🧾 판매자 승인 | -       | `/admin/sellers/pending` | 판매자 신청 승인/거절 | 관리자 | ✅ 완료 (T03) |
| 🏪 가게 관리   | -       | `/admin/stores`          | 전체 가게 목록        | 관리자 | ✅ 완료 (T04) |
| 👥 사용자 관리 | -       | `/admin/users`           | 사용자 목록           | 관리자 | ✅ 완료 (T57) |
| 📦 상품 관리   | -       | `/admin/products`        | 전체 상품 목록        | 관리자 | ✅ 완료 (T57) |
| 📋 주문 관리   | -       | `/admin/orders`          | 전체 주문 목록        | 관리자 | ✅ 완료 (T57) |
...
/seller/dashboard ............ 대시보드 (주문 현황 및 매출 통계)
